...
void main()
{
	...
	vec3 ambient = light.ambient * vec3(texture(material.diffuse, Coords));
    ...
    vec3 specular = light.specular * spec * vec3(texture(material.specular, Coords));
